 ...
 * =====================================================================================
 *
 *       Filename:  bachelor_instantiate.cpp
 *
 *    Description:  instantiate two USRP at full sample rate
 *
 *        Version:  1.0
 *        Created:  16.08.2017 11:34:55
 *       Revision:  none
 *       Compiler:  gcc
 *
...
//    usrp1->set_time_now(uhd::time_spec_t(time(0)));
    ...
    std::cout << boost::format( "hepiaB200 up and running") << std::endl;
    std::cout << boost::format( "sinuxB200 up and running") << std::endl;
